...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/02730532-ada6-4059-a3ef-9354f6f2dabe";
      fsType = "ext4";
    };

  fileSystems."/boot/efi" =
    { device = "/dev/disk/by-uuid/3942-D9BD";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/7da283f6-e80a-4299-a80f-dcf64130989c"; }
    ];
